...
part of 'get_free_cost.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

GetFreeCost _$GetFreeCostFromJson(Map<String, dynamic> json) => GetFreeCost(
      cardType: $enumDecode(_$CardTypeEnumMap, json['card_type']),
      cardId: json['card_id'] as String,
      scopeType: $enumDecode(_$ScopeTypeEnumMap, json['scope_type']),
    );

Map<String, dynamic> _$GetFreeCostToJson(GetFreeCost instance) =>
    <String, dynamic>{
